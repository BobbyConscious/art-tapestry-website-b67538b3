      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-16">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            <img src="/lovable-uploads/971fe0c4-b658-46c2-8aeb-4ebd9dd6cd17.png" alt="CTV" className="h-12 object-contain" />
            <img src="/lovable-uploads/0cf15100-5069-4a45-8f5c-485b4b3c5c23.png" alt="Bell Media" className="h-10 object-contain" />
            <img src="/lovable-uploads/00585485-580b-4479-8219-12af520cb790.png" alt="NOW" className="h-12 object-contain" />
            <img src="/lovable-uploads/167bfc67-75a4-48f7-8aa6-67646f45e330.png" alt="Toronto Caribbean" className="h-12 object-contain" />
