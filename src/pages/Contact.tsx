                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="flex space-x-4 mt-2">
                        ...
                        <a href="https://www.instagram.com/risecollectivecanada" target="_blank" rel="noopener noreferrer" className="text-deep-teal hover:text-warm-terracotta transition-colors" aria-label="Instagram - RISE Collective Canada">
                          <Instagram size={24} />
                        </a>
                        <a href="https://www.twitter.com/riseBIPOC" target="_blank" rel="noopener noreferrer" className="text-deep-teal hover:text-warm-terracotta transition-colors" aria-label="Twitter - RISE BIPOC">
                          <Twitter size={24} />
                        </a>
                      </div>
                    </div>
